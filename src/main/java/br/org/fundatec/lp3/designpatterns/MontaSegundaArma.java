...
public class MontaSegundaArma extends MontaArma {
	...
	public TipoArma segundaArma(Personagem personagem,int segundaArma) throws Exception {
		...
		for (TipoArma tipoSegundaArma : personagem.armasDisponiveis) {
			...
			segundaArma = personagem.getSegundaArma().getTipoArma().getOpcao();
		}

		return montaArma(personagem, segundaArma);
